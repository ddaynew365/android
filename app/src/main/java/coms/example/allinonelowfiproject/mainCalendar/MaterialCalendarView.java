...
import coms.example.allinonelowfiproject.mainCalendar.format.ArrayWeekDayFormatter;
import coms.example.allinonelowfiproject.mainCalendar.format.DayFormatter;
import coms.example.allinonelowfiproject.mainCalendar.format.MonthArrayTitleFormatter;
import coms.example.allinonelowfiproject.mainCalendar.format.TitleFormatter;
import coms.example.allinonelowfiproject.mainCalendar.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    /**
     * Set a {@linkplain coms.example.allinonelowfiproject.mainCalendar.format.TitleFormatter}
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @see coms.example.allinonelowfiproject.mainCalendar.format.MonthArrayTitleFormatter
     * @see #setTitleFormatter(coms.example.allinonelowfiproject.mainCalendar.format.TitleFormatter)
     */
